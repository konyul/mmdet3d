...
def get_image_path(idx,
                   ...
                   info_type='image_2',
                   use_prefix_id=False):
    return get_jrdb_info_path(idx, prefix, info_type, '.jpg', training,
...
def get_label_path(idx,
                   ...
                   info_type='label_2',
                   use_prefix_id=False):
    return get_jrdb_info_path(idx, prefix, info_type, '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_velodyne_path(idx,
                      ...
                      exist_check=True,
                      use_prefix_id=False):
    return get_jrdb_info_path(idx, prefix, 'velodyne', '.npy', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_calib_path(idx,
                   ...
                   exist_check=True,
                   use_prefix_id=False):
    return get_jrdb_info_path(idx, prefix, 'calib', '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_pose_path(idx,
                  ...
                  exist_check=True,
                  use_prefix_id=False):
    return get_jrdb_info_path(idx, prefix, 'pose', '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_jrdb_image_info(path,
    ...
    """
    jrdb annotation format version 2:
    {
        [optional]points: [N, 3+] point cloud
        [optional, for jrdb]image: {
            image_idx: ...
            image_path: ...
            image_shape: ...
        }
        ...
        annos: {
            ...
            [optional]difficulty: jrdb difficulty
...
def get_waymo_image_info(path,
                         ...
                         max_sweeps=5):
    """
    Waymo annotation format version like jrdb:
    {
        [optional]points: [N, 3+] point cloud
        [optional, for jrdb]image: {
            image_idx: ...
...
def jrdb_anno_to_label_file(annos, folder):
    folder = Path(folder)
    for anno in annos:
