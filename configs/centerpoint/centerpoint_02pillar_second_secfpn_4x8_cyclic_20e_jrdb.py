_base_ = [
    '../_base_/datasets/jrdb-3d-pedestrian.py',
...
data_root = 'data/jrdb_short/'
file_client_args = dict(backend='disk')

db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'jrdb_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + 'jrdb_infos_train.pkl',
            split='training',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'jrdb_infos_val.pkl',
        #ann_file=data_root + 'jrdb_infos_train.pkl',
        split='training',
        # pts_prefix='velodyne_reduced',
        pts_prefix='velodyne',
